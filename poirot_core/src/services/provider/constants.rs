pub mod arxiv_text {
    ...
    impl ExpandableCategory for Categories {}
    ...
    impl ExpandableCategory for ComputerScience {}
    ...
    impl ExpandableCategory for Economics {}
    ...
    impl ExpandableCategory for ElectricalEngineeringAndSystemsScience {}
    ...
    impl ExpandableCategory for Mathematics {}
    ...
    impl ExpandableCategory for PhysicsCategory {}
    ...
    impl ExpandableCategory for Astrophysics {}
    ...
    impl ExpandableCategory for CondensedMatter {}
    ...
    impl ExpandableCategory for HighEnergyPhysics {}
    ...
    impl ExpandableCategory for NonLinearSciences {}
    ...
    impl ExpandableCategory for Nuclear {}
    ...
    impl ExpandableCategory for Physics {}
    ...
    impl ExpandableCategory for QuantitativeBiology {}
    ...
    impl ExpandableCategory for QuantitativeFinance {}
    ...
    impl ExpandableCategory for Statistics {}
